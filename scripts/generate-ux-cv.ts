 ...
 *
 * Output:
 *   cv-site/public/cv/Giulio_Occhipinti_UX_Designer_CV.pdf     (IT)
 *   cv-site/public/cv/Giulio_Occhipinti_UX_Designer_CV_EN.pdf  (EN)
 *
 * Uso:
 *   npm run pdf:ux
...
const EN: Locale = {
  ...
  experiences: [
    {
      ...
      bullets: [
        "Flipped ideation to <b>research-first</b>: mapped behavioural needs on Miro, classified by severity and prevalence, before any idea.",
        "Validated with <b>7 target-user interviews</b> + competitor flow analysis; Value Proposition Canvas &amp; a Value/Effort matrix narrowed <b>17 concepts to 1</b>.",
        "Now validating a <b>high-fidelity Figma prototype</b> (Probabilistic PoC) against pre-set thresholds — &gt;8% onboarding, &gt;2% pre-order — behaviours, not opinions.",
      ],
    },
    {
      yr: "2024 — present",
      ...
      bullets: [
        ...
        "Designed a <b>knolling information architecture</b> — one profile, four lenses — and a <b>WCAG-AA design system</b> (tokens, square/glow skill levels, reduced-motion).",
        "Built it AI-augmented (Copilot, Claude) with <b>&gt;80% test coverage</b>; the live site is the proof of the workflow it claims.",
      ],
    },
    {
      yr: "2019 — present",
      ...
      bullets: [
        "Built a <b>100+ component library</b> in Lit <b>with the design team</b>, every component honouring the typography, spacing and states defined in Figma.",
        "Defended visual consistency and component states in code reviews across a <b>30+ person</b> team; <b>3+ years</b> as Tech Lead &amp; Scrum Master of the Aruba Design System.",
        "Enterprise Angular for Intesa San Paolo (50+ people); introduced systematic testing (Jest), improving release stability.",
      ],
    },
    {
      yr: "2023 — 2024",
      ...
      org: "Music Agency",
      bullets: [
        "Designed a content strategy aimed at the industry, not a generic audience; <b>doubled a targeted following</b> (musicians, labels, promoters) organically.",
        "Conceived a playlist as a networking channel; organised a live event end-to-end (booking to communications).",
      ],
    },
  ],
  works: [
  ...
  skills: [
    ...
    {
      label: "Design tools",
      chips: ["Figma", "Miro", "Visily", "UX Pilot", "Google Stitch", "GSAP", "WordPress"],
    },
    {
      label: "Frontend",
  ...
  experiences: [
    {
      ...
      bullets: [
        "Ho ribaltato l'ideazione mettendo la <b>ricerca prima</b>: mappa dei bisogni comportamentali su Miro, classificati per gravità e diffusione, prima di ogni idea.",
        "Validazione con <b>7 interviste a utenti target</b> e analisi dei flussi dei competitor; Value Proposition Canvas e matrice Valore/Sforzo hanno ridotto <b>17 concept a 1</b>.",
        "Ora valido un <b>prototipo Figma ad alta fedeltà</b> (Probabilistic PoC) su soglie fissate prima: oltre 8% onboarding, oltre 2% pre-order. Comportamenti, non opinioni.",
      ],
    },
    {
      yr: "2024 — oggi",
      ...
      bullets: [
        ...
        "Ho progettato un'<b>architettura dell'informazione knolling</b>, un profilo e quattro lenti, e un <b>design system WCAG-AA</b> (token, livelli skill square/glow, reduced-motion).",
        "Costruito AI-augmented (Copilot, Claude) con <b>oltre 80% di copertura test</b>; il sito live è la prova del metodo che dichiara.",
      ],
    },
    {
      yr: "2019 — oggi",
      ...
      org: "ALTEN Italia @ Aruba &amp; Intesa San Paolo",
      bullets: [
        "Ho costruito una <b>libreria di 100+ componenti</b> in Lit <b>insieme al team di design</b>, ogni componente rispetta tipografia, spaziature e stati definiti in Figma.",
        "Ho difeso coerenza visiva e stati dei componenti nelle code review su un team di <b>30+ persone</b>; <b>3+ anni</b> come Tech Lead e Scrum Master del Design System Aruba.",
        "Architettura Angular enterprise per Intesa San Paolo (50+ persone); ho introdotto test sistematici (Jest), migliorando la stabilità dei rilasci.",
      ],
    },
    {
      yr: "2023 — 2024",
      ...
      org: "Music Agency",
      bullets: [
        "Ho progettato una content strategy rivolta al settore, non a un pubblico generico; ho <b>raddoppiato un seguito mirato</b> (musicisti, etichette, promoter) in modo organico.",
        "Ho ideato una playlist come canale di networking; ho organizzato un evento live end-to-end (dal booking alla comunicazione).",
      ],
    },
  ],
  works: [
...
/* Experience */
.entry{display:grid;grid-template-columns:34mm 1fr;gap:6mm;padding:2.1mm 0;
...
/* CTA */
.cta{margin-top:7mm;border:1.5px solid var(--line-or);background:var(--surface);border-radius:3mm;
...
// Esegui solo se invocato direttamente (non all'import, così i test/preview
