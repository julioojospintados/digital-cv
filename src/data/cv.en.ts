...
export const cvDataEn = {
  ...
  experience: [
    ...
    },
    {
      ...
      role: "AI Content Strategist & Operations Manager",
      startDate: "2023-01",
      endDate: "2024-12",
      location: "Italy",
      remote: true,
      description: "Strategic and operational collaboration with an Italian music agency: from designing a full marketing plan to grow artists' visibility, to producing AI-augmented content — monologues, copy, custom HTML email templates — through to concert organisation and outreach campaigns on Instagram and Spotify. AI was used systematically to accelerate creative content production, generate copy variants for testing, and optimise communications while preserving each artist's authentic voice.",
      highlights: [
        "Designed and implemented a structured marketing plan for Instagram and Spotify, including a dedicated organic growth strategy and an editorial content calendar",
        "Produced custom HTML email templates for promotional campaigns: writing, design, and direct delivery to segmented audiences",
        "Wrote monologues and copy for live events, artist presentations and social content, with AI assistance for variants and tone optimisation",
        "Designed a monthly 'artist link' playlist concept to connect emerging artists with the agency, boosting engagement and Spotify collaboration network",
        "Built and maintained a structured contact list for concert organisation: promoters, venues, agents, media",
        "Organised and coordinated concerts: logistics, venue communication, artist management and event timeline",
        "Coordinated between artists and digital platforms (Spotify, YouTube Music, aggregators) for releases and distributions",
        "Project management of releases and promotional campaigns using an iterative approach applied to the music editorial cycle",
      ],
      skills: ["Content Strategy", "Email Marketing", "HTML Email", "Copywriting", "Instagram Marketing", "Spotify Marketing", "AI-augmented Copywriting", "Playlist Curation", "Event management", "Influencer Outreach", "Digital communication", "Music business", "Project management"],
