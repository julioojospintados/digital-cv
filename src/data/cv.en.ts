...
export const cvDataEn = {
  ...
  experience: [
    ...
    },
    {
      ...
      location: "Turin, Italy",
      remote: true,
      description: "Design and development of an interactive CV as a systematic proving ground for an end-to-end AI-augmented workflow. The entire cycle — architecture, UI, GSAP animations, MCP server, HTTP API with Hono — was built with GitHub Copilot and Claude as operational co-pilots, applying structured Prompt Engineering at every phase: specification, review, debugging, refactoring. The result is a two-layer system: an Astro + Lit site for the visual CV, and an MCP server that exposes CV data as an API for AI agents. The project is also a live demonstration that a solo developer, with AI as a force multiplier, can produce in weeks what a team would need months to deliver.",
      highlights: [
        ...
        "70% reduction in development time compared to a traditional approach, while maintaining Awwwards-level UI quality",
      ],
    ...
    },
    {
      ...
      highlights: [
        ...
        "Live show logistics: venue communication, artist management and technical riders",
        "Digital presence strategy on Instagram and Spotify to grow the visibility of roster artists",
        "Production of communication materials (copy, emails, artist presentations) with AI support to reduce turnaround time",
        "Coordination with aggregators and digital platforms (Spotify, YouTube Music) for distributions and releases",
      ],
      skills: ["Booking", "Tour management", "Event management", "Digital communication", "Content Strategy", "Copywriting", "Instagram Marketing", "Spotify Marketing", "Music business", "Project management"],
  ...
  technicalSkills: [
    ...
    { name: "NGRX", level: "Intermedio", links: [
      { target: "Angular",                type: "technical" },
      { target: "RXJS",                   type: "technical" },
      { target: "TypeScript",             type: "technical" },
    ]},
  ...
  // ── Soft skills ───────────────────────────────────────────────────────────
  softSkills: [
    { name: "Effective communication", description: "Over 10 years of public event hosting and theatre training: ability to convey complex messages clearly, engagingly and calibrated to any type of audience.", links: [
    ...
    { name: "Applied creativity", description: "Multidisciplinary background (software development, photography, theatre, writing, events) that generates original approaches and unexpected solutions even in technical contexts.", links: [
    ...
    { name: "Cultural adaptability", description: "Work experience across 5 countries (Italy, UK, Mexico, Tanzania, Luxembourg), each with a profoundly different organisational, linguistic and cultural context.", links: [
      { target: "Relational intelligence",       type: "conceptual" },
      { target: "Resilience and adaptive thinking", type: "conceptual" },
      { target: "Public speaking",               type: "cross-domain" },
      { target: "Event management",              type: "cross-domain" },
    ]},
    { name: "Relational intelligence", description: "Natural ability to build trust with colleagues, clients and stakeholders, developed in high-variability environments: from international customer service to cross-functional team management.", links: [
      { target: "Effective communication",       type: "conceptual" },
      { target: "Cultural adaptability",         type: "conceptual" },
      { target: "Event management",              type: "cross-domain" },
      { target: "Public speaking",               type: "cross-domain" },
    ]},
    { name: "Lateral problem solving", description: "Analytical and cross-domain approach to problems: experience in complex enterprise environments (microfrontend architectures, legacy systems) and high-stress live situations (technical direction, event hosting).", links: [
      { target: "Applied creativity",            type: "conceptual" },
      { target: "T-shaped thinking",             type: "conceptual" },
      { target: "Agile Methodology",             type: "cross-domain" },
      { target: "MCP Protocol",                  type: "cross-domain" },
    ]},
    { name: "Autonomy and ownership", description: "Independent management of parallel projects (freelance photography, videography, strategic consultancy) with the ability to set priorities, meet deadlines and deliver results without direct supervision.", links: [
      { target: "Resilience and adaptive thinking", type: "conceptual" },
      { target: "Agile Methodology",             type: "cross-domain" },
      { target: "T-shaped thinking",             type: "conceptual" },
      { target: "Git",                           type: "cross-domain" },
    ]},
    { name: "Resilience and adaptive thinking", description: "Clarity under pressure trained through theatre technical direction, live event hosting and the management of enterprise systems in production. The unexpected is treated as data to learn from.", links: [
      { target: "Autonomy and ownership",        type: "conceptual" },
      { target: "Cultural adaptability",         type: "conceptual" },
      { target: "Theatre and improvisation",     type: "cross-domain" },
      { target: "Agile Methodology",             type: "cross-domain" },
    ]},
    { name: "Aesthetic sensibility", description: "Over 15 years of photographic practice and visual production translate into more effective UI choices, with a direct impact on brand perception and the quality of the user experience.", links: [
      { target: "Applied creativity",            type: "conceptual" },
      { target: "Photography",                   type: "cross-domain" },
      { target: "Graphic design",                type: "cross-domain" },
      { target: "UX / UI Design",               type: "cross-domain" },
    ...
    { name: "T-shaped thinking", description: "Ability to bridge engineering (Frontend), design (UX/UI) and marketing (SEO/SEM), reducing communication silos and accelerating the time-to-market of digital products.", links: [
      { target: "Lateral problem solving",       type: "conceptual" },
      { target: "Autonomy and ownership",        type: "conceptual" },
  ...
  // ── Transversal skills ────────────────────────────────────────────────────
  transversalSkills: [
    { name: "Event management", description: "Conception and production of multidisciplinary cultural festivals (Square Festival, Artiversum – Quadrilatero Romano, Turin): artist coordination, logistics and institutional communications.", links: [
      { target: "Agile Methodology",             type: "cross-domain" },
    ...
    { name: "Photography", description: "Continuous freelance practice since 2009, with an international portfolio (Tanzania, Mexico, Italy). Specialisation in reportage and portraiture.", links: [
      { target: "Applied creativity",            type: "cross-domain" },
      { target: "Aesthetic sensibility",         type: "cross-domain" },
      { target: "Videography",                   type: "technical" },
      { target: "Video editing",                 type: "workflow" },
    ]},
    { name: "Theatre and improvisation", description: "Training and stage work with B-Teatro (2013–2020), performances in Italy and Luxembourg. Improvisation trains active listening, rapid thinking and the ability to turn failure into a resource.", links: [
      { target: "Public speaking",               type: "workflow" },
      { target: "Effective communication",       type: "workflow" },
      { target: "Resilience and adaptive thinking", type: "cross-domain" },
      { target: "Agile Methodology",             type: "conceptual" },
    ]},
    { name: "Public speaking", description: "Hosting of festivals, panels and talks with international guests since 2015. Ability to manage diverse audiences and unexpected live situations with composure and authority.", links: [
      { target: "Theatre and improvisation",     type: "workflow" },
      { target: "Effective communication",       type: "workflow" },
      { target: "Event management",              type: "workflow" },
      { target: "Relational intelligence",       type: "conceptual" },
    ]},
    { name: "Graphic design", description: "Specialist training (Immaginazione e Lavoro, 2018) with ongoing application in the production of visual materials for events, brand and digital communications.", links: [
      { target: "Aesthetic sensibility",         type: "cross-domain" },
      { target: "Applied creativity",            type: "cross-domain" },
    ...
    { name: "Social media management", description: "Specialist training (Immaginazione e Lavoro, 2018) and practical application in editorial management for cultural event channels and the music agency.", links: [
    ...
    { name: "Digital marketing", description: "IED Master in Digital Communication (2022–2023): content strategy, SEO/SEM, analytics, campaign management and brand storytelling in B2C and B2B contexts.", links: [
      { target: "Social media management",       type: "workflow" },
      { target: "SEO",                           type: "technical" },
      { target: "SEM",                           type: "technical" },
      { target: "Writing and poetry",            type: "cross-domain" },
    ...
    { name: "UX / UI Design", description: "IBM UX Design Professional Certificate in progress: User Research, Information Architecture, Wireframing and high-fidelity prototyping with Figma.", links: [
      { target: "Figma",                         type: "workflow" },
      { target: "UX Research",                   type: "workflow" },
      { target: "Wireframing",                   type: "workflow" },
      { target: "Aesthetic sensibility",         type: "cross-domain" },
    ...
    { name: "Videography", description: "Direction and video production for high-end weddings in Tuscany: crew management in multicultural contexts, color grading and narrative editing for an international premium market.", links: [
      { target: "Photography",                   type: "technical" },
      { target: "Applied creativity",            type: "cross-domain" },
      { target: "Video editing",                 type: "workflow" },
      { target: "Aesthetic sensibility",         type: "cross-domain" },
    ]},
    { name: "Agile Methodology", description: "Scrum and Kanban applied in distributed enterprise teams (ALTEN, Intesa San Paolo, Aruba) and in personal creative projects. Hands-on experience in sprint planning, retrospectives and backlog management.", links: [
      { target: "T-shaped thinking",             type: "cross-domain" },
      { target: "Autonomy and ownership",        type: "cross-domain" },
      { target: "Theatre and improvisation",     type: "conceptual" },
      { target: "Event management",              type: "cross-domain" },
    ...
    { name: "AI-Augmented Productivity", description: "Systematic integration of GitHub Copilot, ChatGPT and Midjourney into development, UX research and content production workflows. AI expands quality and speed without replacing critical judgement.", links: [
      { target: "Prompt Engineering",            type: "workflow" },
      { target: "MCP Protocol",                  type: "workflow" },
      { target: "T-shaped thinking",             type: "cross-domain" },
      { target: "Agile Methodology",             type: "cross-domain" },
    ]},
    { name: "Writing and poetry", description: "Award-winning author at international level (Italy and Australia). Creative writing practice translates into more effective copy, product storytelling and strategic synthesis skills.", links: [
      { target: "Effective communication",       type: "cross-domain" },
      { target: "Applied creativity",            type: "cross-domain" },
      { target: "Public speaking",               type: "workflow" },
      { target: "Digital marketing",             type: "cross-domain" },
    ]},
    { name: "Music industry", description: "Coordination between artists, digital aggregators and streaming platforms (Spotify, YouTube Music). Experience in release management, strategic communication and editorial project management (2023–2024).", links: [
      { target: "Event management",              type: "workflow" },
      { target: "Social media management",       type: "workflow" },
      { target: "Digital marketing",             type: "workflow" },
      { target: "Effective communication",       type: "cross-domain" },
  ...
  valueFlows: [
    {
      ...
      description: "From business need to deployment: the full cycle combining user research, iterative design, development and measurable delivery.",
    ...
    },
    {
      ...
      description: "How I take a team from 'operational chaos' to 'conscious autonomy': improvisation as methodology, Agile as structure, communication as the binding agent.",
      steps: ["Theatre and improvisation", "Agile Methodology", "Effective communication", "T-shaped thinking", "Autonomy and ownership", "Git"],
    },
    {
      name: "Strategic Product Communication",
      description: "From copy to campaign: the narrative flow that transforms a technical product into a story the client actually wants to hear.",
      steps: ["Writing and poetry", "Public speaking", "Aesthetic sensibility", "Graphic design", "Digital marketing", "Social media management"],
    },
    {
      name: "AI-First Implementation Workflow",
      description: "The GO Automated method: every repeatable process becomes an agent. From AI architecture to zero-touch deployment in 1–2 week sprints.",
