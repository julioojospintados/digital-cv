...
export const cvData = {
  ...
  experience: [
    ...
    },
    {
      ...
      role: "AI Content Strategist & Responsabile Operativo",
      startDate: "2023-01",
      endDate: "2024-12",
      location: "Italia",
      remote: true,
      description: "Collaborazione strategica e operativa con un'agenzia musicale italiana: dall'ideazione di un piano marketing completo per la crescita della visibilità degli artisti, alla produzione di contenuti AI-augmented — monologhi, copy, template email HTML personalizzati — fino all'organizzazione di concerti e campagne di outreach su Instagram e Spotify. L'AI è stata usata sistematicamente per accelerare la produzione di contenuti creativi, generare varianti di copy per test e ottimizzare la comunicazione, mantenendo sempre la voce autentica degli artisti.",
      highlights: [
        "Ideazione e implementazione di un piano marketing strutturato per Instagram e Spotify, con sezione dedicata alla crescita organica dei follower e strategia di contenuto editoriale",
        "Produzione di template email HTML personalizzati per campagne promozionali: scrittura, design e invio diretto a audience segmentate",
        "Scrittura di monologhi e copy per eventi live, presentazioni artisti e contenuti social, con supporto AI per varianti e ottimizzazione del tono",
        "Progettazione di una playlist mensile 'artist link' per connettere artisti emergenti all'agenzia, aumentando engagement e rete di collaborazioni su Spotify",
        "Creazione e gestione di una lista contatti strutturata per l'organizzazione di concerti: promoter, venue, agenti, media",
        "Organizzazione e coordinamento di concerti: logistica, comunicazione con venue, gestione artisti e timeline eventi",
        "Coordinamento tra artisti e piattaforme digitali (Spotify, YouTube Music, aggregatori) per release e distribuzioni",
        "Project management di release e campagne promozionali con metodologia iterativa applicata al ciclo editoriale musicale",
      ],
      skills: ["Content Strategy", "Email Marketing", "HTML Email", "Copywriting", "Instagram Marketing", "Spotify Marketing", "AI-augmented Copywriting", "Playlist Curation", "Event management", "Influencer Outreach", "Comunicazione digitale", "Music business", "Project management"],
