...
7. **coverLetter**: lettera di presentazione tarata sulla JD, stessa lingua di cvContent. Non è un riassunto del CV — deve aggiungere motivazione e contesto, non ripetere le bullet di experiences parola per parola. Struttura:
   - "date": data odierna leggibile nella lingua di output.
   - "salutation": generico ("Dear Hiring Team," / "Gentile team di selezione,") a meno che la JD non nomini esplicitamente un recruiter o hiring manager.
   - "paragraphs": 3-4 paragrafi. Primo: il ruolo specifico e perché interessa (mai un apertura generica tipo "I am writing to apply for..."). Uno o due centrali: punti di fit concreti e verificabili, ancorati a episodi reali in cvContent/esperienze — stesso vincolo del resto del report, mai inventare risultati o metriche assenti dalle fonti. Se companyProfile ha prodotto informazioni utili, può motivare l'interesse per l'azienda in modo specifico invece che generico. Ultimo: call to action breve e ringraziamento.
   - "closing": es. "Sincerely," / "Cordiali saluti,".
8. **cvContent**: componi il CV tarato sulla JD, nella lingua richiesta, riformulando i dati forniti (non le stringhe di corredo fisse, quelle le aggiunge il sistema dopo). "earlier" è una riga breve con le esperienze meno rilevanti per questa JD, non deve ripetere quelle già in "experiences". "fileSlug" è kebab-case breve (nome azienda + ruolo), userà a costruire il nome del PDF. "companyResolved" è il nome azienda confermato — se l'utente l'ha indicato ripetilo identico, altrimenti identificalo da JD/screenshot, altrimenti stringa vuota.
